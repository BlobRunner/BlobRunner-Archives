...
public class Camera2Wrapper implements C0054d {
    ...
    public int[] getCamera2Resolutions(int i) {
        if (C0060j.f221b) {
            return C0042a.m129d(this.f3a, i);
        }
        return null;
    }
    ...
    public int getCamera2SensorOrientation(int i) {
        if (C0060j.f221b) {
            return C0042a.m108a(this.f3a, i);
        }
        return 0;
    }
    ...
    public Rect getFrameSizeCamera2() {
        return this.f4b != null ? this.f4b.mo171a() : new Rect();
    }

    /* access modifiers changed from: protected */
    public boolean initializeCamera2(int i, int i2, int i3, int i4, int i5) {
        if (!C0060j.f221b || this.f4b != null || UnityPlayer.currentActivity == null) {
            return false;
        }
        this.f4b = new C0042a(this);
        return this.f4b.mo173a(this.f3a, i, i2, i3, i4, i5);
    }

    /* access modifiers changed from: protected */
    public boolean isCamera2AutoFocusPointSupported(int i) {
        if (C0060j.f221b) {
            return C0042a.m126c(this.f3a, i);
        }
        return false;
    }
    ...
    public boolean isCamera2FrontFacing(int i) {
        if (C0060j.f221b) {
            return C0042a.m124b(this.f3a, i);
        }
        return false;
    }
    ...
    public boolean setAutoFocusPoint(float f, float f2) {
        if (!C0060j.f221b || this.f4b == null) {
            return false;
        }
        return this.f4b.mo172a(f, f2);
    }
